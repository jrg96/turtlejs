...
var basic1 = new BasicBlockPalette(495, 200, '#FFD000', draw_stage.layer, new BasicBlockDesc(), global_tracker);
palette_tracker.add_palette(basic1);

var pen_palette = new PenPalette(640, 160, '#FFD000', draw_stage.layer, new PenPaletteDesc(), global_tracker);
palette_tracker.add_palette(pen_palette);

var colors_palette = new ColorsPalette(550, 160, '#FFD000', draw_stage.layer, new ColorsPaletteDesc(), global_tracker);
palette_tracker.add_palette(colors_palette);

var flow_palette = new FlowPalette(575, 160, '#FFD000', draw_stage.layer, new FlowPaletteDesc(), global_tracker);
palette_tracker.add_palette(flow_palette);

var numbers_palette = new NumbersPalette(475, 150, '#FFD000', draw_stage.layer, new NumbersPaletteDesc(), global_tracker);
palette_tracker.add_palette(numbers_palette);

var blocks_palette = new BlocksPalette(475, 150, '#FFD000', draw_stage.layer, new BlocksPaletteDesc(), global_tracker);
