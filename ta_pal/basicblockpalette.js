...
palette_container.create_palette('turtle_palette');


var sprit1 = new Sprite(image_tracker.get_resource('basic1arg'), this.container.layer, true);
palette_container.add_block_factory('turtle_palette', 'forward_block', [[5, 5], sprit1, 'forward_block', null, [DEFAULT_LANG, BLOCK_SIDE, 'forward']]);

sprit1 = new Sprite(image_tracker.get_resource('basic1arg'), this.container.layer, true);
palette_container.add_block_factory('turtle_palette', 'backward_block', [[120, 5], sprit1, 'backward_block', null, [DEFAULT_LANG, BLOCK_SIDE, 'backward']]);

sprit1 = new Sprite(image_tracker.get_resource('basic1arg'), this.container.layer, true);
palette_container.add_block_factory('turtle_palette', 'right_block', [[235, 5], sprit1, 'right_block', null, [DEFAULT_LANG, BLOCK_SIDE, 'right']]);

sprit1 = new Sprite(image_tracker.get_resource('basic1arg'), this.container.layer, true);
palette_container.add_block_factory('turtle_palette', 'right_block', [[350, 5], sprit1, 'left_block', null, [DEFAULT_LANG, BLOCK_SIDE, 'left']]);

sprit1 = new Sprite(image_tracker.get_resource('box2_purple'), this.container.layer, true, false, null, null, [0, 28, 82]);
palette_container.add_block_factory('turtle_palette', 'right_block', [[5, 55], sprit1, 'box_block', null, [DEFAULT_LANG, BLOCK_SIDE, 'number']]);
