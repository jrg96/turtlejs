...
PenPaletteDesc.prototype = {
    ...
    init_descriptor: function(){
        ...
        new BlockDescriptor(image_tracker.get_resource('basic1arg'), 'basic1arg', set_pen_size, null, ['set_pen_size_block', DEFAULT_LANG, FACTORY_SIDE, this.descriptors, ['int']]);
        ...
        new BlockDescriptor(image_tracker.get_resource('basic1arg'), 'basic1arg', set_color, null, ['set_color_block', DEFAULT_LANG, FACTORY_SIDE, this.descriptors, ['str_int']]);

        new BlockDescriptor(image_tracker.get_resource('basic1arg'), 'basic1arg', set_shade, null, ['set_shade_block', DEFAULT_LANG, FACTORY_SIDE, this.descriptors, ['int']]);

        new BlockDescriptor(image_tracker.get_resource('basic1arg'), 'basic1arg', set_gray, null, ['set_gray_block', DEFAULT_LANG, FACTORY_SIDE, this.descriptors, ['int']]);
